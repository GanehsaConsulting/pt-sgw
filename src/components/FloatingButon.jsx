        ...
        <>
            <div className="fixed bottom-5 right-5 z-[100]">
                <section className="flex flex-col gap-3 duration-300">
                    <button
                        onClick={scrollToTop}
                        className={`${isVisible ? "scale-100 " : 'scale-0 translate-x-full'} bg-darkColor bg-opacity-50 duration-300 backdrop-blur-md hover:bg-mainColor hover:text-baseColor dark:text-white  text-mainColor rounded-full p-4 shadow-lg`}
                    >
